...
const urlhost = "http://localhost:3000/api/products/" + id; // L'adreça API
...
let dadesRecull = function() {
	...
	.then((dades) => { console.log(dades);
	  ...
	  fotoProducte.innerHTML =`<img src="${dades.imageUrl}" alt="${dades.altTxt}">`;
        ...
        // Atenció: la característica colors, és una Array dintre l'Array Principal. Hem de crear un bucle per presentar tots els valors disponibles.
